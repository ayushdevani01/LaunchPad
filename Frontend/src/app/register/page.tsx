                ...
                >
                    ...
                    <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <button
                                type="button"
                                className="w-full h-12 bg-white/5 border border-white/10 rounded-xl font-bold text-lg hover:bg-white/10 transition-colors flex items-center justify-center gap-2 text-white opacity-50 cursor-not-allowed"
