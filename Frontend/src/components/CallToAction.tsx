  ...
  return (
    <div className="bg-black text-white py-[72px] sm:py-24" ref={containerRef}>
      ...
      <div className="container max-w-xl relative">
        ...
        <p className="text-xl text-white/70  mt-5">Start deploying your applications today with our secure scalable and easy to use platform.</p>
        <form className="mt-10 flex flex-col gap-2.5 max-w-sm mx-auto sm:flex-row">
          <input type="email" placeholder="support@launch-pad.dev" className="h-12 bg-white/20 rounded-lg px-5 font-medium placeholder:text-[#9CA3AF] sm:flex-1" />
